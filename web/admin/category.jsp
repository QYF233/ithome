  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        ...
        <li><a href="comment.action">评论</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          ...
          <form action="CategoryAdd.action" method="post" autocomplete="off">
            <div class="form-group">
              <label for="category-name">栏目名称</label>
              <input type="text" id="category-name" name="classify" class="form-control" placeholder="在此处输入栏目名称" required autocomplete="off">
            ...
            <div class="form-group">
              ...
              <select id="category-fname" class="form-control" name="fid">
                ...
                <c:forEach items="${all}" var="all" >
                  <option value="${all.id}" >${all.classify}</option>
                </c:forEach>
              </select>
            ...
            <table class="table table-striped table-hover">
              ...
              <c:forEach items="${all}" var="all" varStatus="status" >
                <tr>
                  ...
                  <td>${all.alias}</td>
                  <td>125</td>
                  <td><a href="queryCategory.action?id=${all.id}">修改</a> <a rel="${all.id}" href="CategoryDel.action?id=${all.id}">删除</a></td>
                </tr>
              </c:forEach>
                </tr>
              </tbody>
