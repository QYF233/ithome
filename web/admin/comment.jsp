        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../index.jsp">ithome</a>
                </div>
    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="listComment.action">评论</a></li>
        ...
        <div
            ...
            <form action="delAllComment.action" method="post">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            <td><input type="checkbox" class="input-control" name="checkbox"
                                       value="<s:property value="#list.id" />"/></td>
                            <td class="article-title"><s:property value="#list.comment" />
                            </td>
                            <td class="article-title">
                                <a href=".../info.action?id=<s:property value="#list.id" />"  target="_blank">
                                    <s:property value="#list.title" />
                                </a>
                            </td>
                            <td><s:property value="#list.time" />
                            </td>
                            <td><a rel="1" name="see"
                                   href="../info.action?id=<s:property value="#list.articleid" />#gbko" target="_blank">查看</a>
                                <a name="delete" href="queryComment.action?id=<s:property value="#list.id" />">修改</a>
                                <a name="delete" href="delComment.action?id=<s:property value="#list.id" />">删除</a>
                            </td>
                        </tr>
