<%@ page language="java" import="java.sql.*" import="com.db.DataBaseConnection" pageEncoding="utf-8" %>
<%@ page import="com.count.stoptime.UserLine" %>
...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="images/icon/d.png">
    <link rel="shortcut icon" href="images/icon/d.ico">
    <script src="js/jquery-2.1.4.min.js"></script>
    <script src="js/NowTime.js" charset="gb2312" type="text/javascript"></script>
    <script src="https://cdn.jsdelivr.net/npm/vue"></script>
    <script src="https://cdn.bootcss.com/moment.js/2.24.0/moment.min.js" type="text/javascript"
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../ithome.action">ithome</a></div>
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="exit.jsp" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="../adminIndex.action">首页</a></li>
            </ul>
            <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <div class="row placeholders">
                <div class="col-xs-6 col-sm-3 placeholder">
                    ...
                    <span class="text-muted"><s:property value="count1" default="0"/>条</span></div>
                <div class="col-xs-6 col-sm-3 placeholder">
                    <h4>评论</h4>
                    <span class="text-muted"><s:property value="count2" default="0"/> 条</span></div>
                <div class="col-xs-6 col-sm-3 placeholder">
                    <h4>友链</h4>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td>登录时间: <%=userline.getStartTime()%> , 登录IP:<%=userline.getUserip()%>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td>浏览器:</td>
                        <td>Google Chrome 78.0.3904.97</td>
                        <td>JDK版本:</td>
                        <td>1.6.0</td>
                    </tr>
                    <tr>
                        ...
                        <td>JSP运行方式:</td>
                        <td>IntelliJ IDEA 2019.2.3 x64</td>
                    </tr>
                    <tr>
                        <td>登录者IP:</td>
                        <td><%=userline.getUserip()%>
                        </td>
                        <td>MYSQL版本:</td>
                        <td>5.3.40</td>
                    </tr>
                    <tr>
                        <td>程序版本:</td>
                        <td class="version">ITHome 1.0 <font size="-6" color="#BBB">(20191113181138)</font></td>
                        <td>上传文件:</td>
            ...
            <footer>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        <tbody>
                        <tr>
                            <td><span style="display:inline-block; width:8em">版权所有</span> IT之家，软媒旗下科技门户网站 - 爱科技，爱这里。
                            </td>
                        </tr>
                        <tr>
                            <td><span style="display:inline-block;width:8em">页面加载时间</span> PROCESSED IN 1.0835s SECONDS
                                查看更多：<a href="http://www.ithome.com/" target="_blank">IT之家</a></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table" style="margin-bottom:0px;">
                        ...
                        <tr>
                            <td wdith="20%">姓名:</td>
                            <td width="80%"><input type="text" value="求琰锋" class="form-control" name="truename"
                        ...
                        <tr>
                            <td wdith="20%">电话:</td>
                            <td width="80%"><input type="text" value="18258052687" class="form-control" name="usertel"
...
<div id="rightClickMenu">
    <ul class="list-group rightClickMenuList">
        ...
        <li class="list-group-item"><span>IP：</span><%=userline.getUserip()%>
        </li>
