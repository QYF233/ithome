<%
    ...
    String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + path + "/admin/article";
%>
...
<section class="container-fluid">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../ithome.action">ithome</a>
                </div>
                <div class="collapse navbar-collapse"
                    ...
                    <form action="list.action" method="post" class="navbar-form navbar-right"
                          role="search">
                        <%--搜索功能--%>
                        <div class="input-group">
                            <input type="text" class="form-control" name="key"
                                   value="${key}" autocomplete="off" placeholder="键入关键字搜索"
                                   maxlength="15">
    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li><a href="CategoryList.action">栏目</a></li>
        ...
        <div
                ...
                id="main">
            <form action="delAll.action" method="post">
                <h1 class="page-header">操作</h1>
                <ol class="breadcrumb">
                    <li><a href="addQuery.action">增加文章</a></li>
                </ol>
                <h1 class="page-header">
                    <!-- 文章总数 -->
                    管理 <span class="badge"><s:property value="#request.count"/></span>
                </h1>
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm"><span
                                    class="glyphicon glyphicon-tag"></span> <span
                                    class="visible-lg">评论数</span></th>
                            <th class="hidden-sm"><span
                                    class="glyphicon glyphicon-comment"></span> <span
                                    class="visible-lg">图片</span></th>
                        ...
                        <s:iterator value="articles" var="article">
                            <tr class="">
                                <td class="col-lg-1">
                                    <input type="checkbox" class="input-control" name="checkbox" value="<s:property value="#article.id" />"/>
                                </td>
                                <td class="article-title col-lg-4">
                                    <a href="../info.action?id=<s:property value="#article.id" />" target="_blank">
                                        <s:property value="#article.title" />
                                    </a>
                                </td>
                                <td class="col-lg-1"><s:property value="#article.author" />
                                </td>
                                <td class="col-lg-1"><s:property value="#article.classify" />
                                </td>
                                <td class="hidden-sm col-lg-1"><s:property value="#article.tags" />
                                </td>
                                <td class="hidden-sm col-lg-1"><s:property value="#article.commentnum" />
                                </td>
                                <td class="hidden-sm col-lg-1" align="">
                                     <img id="pic" name="pic" src="../images/<s:property value="#article.pic" />">
                                </td>
                                <td class="col-lg-20"><s:property value="#article.time" />
                                </td>
                                <td class="col-lg-1">
                                    <a href="input.action?id=<s:property value="#article.id" />">修改</a>
                                    <a rel="6" href="del.action?id=<s:property value="#article.id"/>">删除</a></td>
                            </tr>
                        </s:iterator>
                        </tbody>
                    </table>
                ...
                <footer class="message_footer">
                    <nav>
                        <div class="btn-toolbar operation" role="toolbar">
                            ...
                            <div class="btn-group" role="group">
                                <button type="submit" class="btn btn-default"
                                        ...
                                        name="checkbox_delete" onclick="">删除
                                </button>
                            </div>
                        </div>
                        <script>
                        ...
                        <ul class="pagination pagenav">
                            <c:if test="${pg>1&&pg<totalPage}">
                                <li class=""><a aria-label="Previous"
                                                href="list.action?pg=1&key=${key}"><span>首页</span></a>
                                </li>
                                <li class=""><a href="list.action?pg=${pg-1}&key=${key}">上一页</a></li>
                                <li class=""><a href="list.action?pg=${pg+1}&key=${key}">下一页</a></li>
                                <li><a href="list.action?pg=${totalPage}&key=${key}" aria-label="Next">
                                    <span aria-hidden="true">尾页</span></a></li>
                            </c:if>
                            <c:if test="${pg==totalPage&&pg>1}">
                                <li class=""><a aria-label="Previous"
                                                href="list.action?pg=1&key=${key}"><span>首页</span></a>
                                </li>
                                <li class=""><a href="list.action?pg=${pg-1}&key=${key}">上一页</a></li>
